// FIFA World Cup 2026 — Annex C: best-third-placed assignment table (all 495 combinations).
// Key   = the 8 groups whose third-placed team qualifies, as sorted letters (e.g. "EFGHIJKL").
// Value = { <winnerGroupSlot>: <thirdGroupAssigned> } for the eight Round-of-32 slots
//         that face a third-placed team (group-winner slots A,B,D,E,G,I,K,L).
// Parsed from the official regulations (via Wikipedia template). Do not edit by hand.
